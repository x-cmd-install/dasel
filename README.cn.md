...
[![x-cmd/install — dasel Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/dasel.svg?lang=zh)](https://x-cmd.com/install/dasel)
...
| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 29,903 | 970 | 3,501 | 275 |
| Toml | 47 | 15 | 21 | 1 |
| Dockerfile | 12 | 0 | 6 | 1 |
| Yaml | 9 | 1 | 3 | 1 |
| Markdown | 0 | 900 | 518 | 8 |
...
- **Signed-Releases** (0/10) — 0 out of 5 artifacts are signed or have provenance
- **Branch-Protection** (3/10) — branch protection is not maximal on development and all release branches

## 源代码

- **上游仓库**: <https://github.com/tomwright/dasel>
- **官网**: <https://daseldocs.tomwright.me>
- **许可证**: MIT
...
- **Star**: 8,042 · **Fork**: 173 · **开放 issue**: 206 · **贡献者**: 32
...
| last60d | 2026-07-28 | 0 | 4 | 3 | 0 | 0 | 4 |
| 90d | 2026-06-28 | 0 | 4 | 4 | 1 | 1 | 4 |
| last180d | 2026-03-30 | 12 | 8 | 9 | 4 | 1 | 67 |
| 360d | 2025-10-01 | 26 | 30 | 10 | 25 | 1 | 136 |
| last720d | 2024-10-06 | 26 | 49 | 10 | 32 | 6 | 170 |
...
dasel 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `dasel` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/dasel.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T03:41:26Z._
