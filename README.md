...
[![x-cmd/install — dasel Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/dasel.svg)](https://x-cmd.com/install/dasel)
...
Total: **29,971** lines of code across **286** files in the top 5 languages.
...
- **Latest**: `v3.11.2` (2026-06-27)
- **Last commit**: 2026-08-16
- **Assets in release**: 16

## Popularity

- **Stars**: 8,039 · **Forks**: 174 · **Open issues**: 206 · **Contributors**: 32
...
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/dasel.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260923.yml` · 2026-09-23T03:28:47Z._
